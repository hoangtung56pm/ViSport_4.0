...
namespace VNM_ViSport_SpamSms.Library
{
    public class SMS_MTDB_SQL
    {
        ...
        public static DataTable GetMTByStatus(bool isLock)
        {
            ...
            SqlCommand dbCmd = new SqlCommand("ViSport_GetAllUserByType_SpamSms", dbConn);
        ...
        {
            SqlConnection dbConn = new SqlConnection(SMS.Default.cnn);
            SqlCommand dbCmd = new SqlCommand("ViSport_UpdateByList_SpamSms_SentMt", dbConn);
            dbCmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlConnection dbConn = new SqlConnection(SMS.Default.cnn);
            SqlCommand dbCmd = new SqlCommand("ViSport_S2_Registered_Users_Update_Fail_SpamSms_SentMt", dbConn);
            dbCmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlConnection dbConn = new SqlConnection(SMS.Default.cnn);
            SqlCommand dbCmd = new SqlCommand("ViSport_S2_Charged_Users_Log_Insert", dbConn);
            dbCmd.CommandType = CommandType.StoredProcedure;
