#pragma checksum "D:\VU_NGUYEN\ViSport\VISPORT_TO_MrVU\ViSport_4.0\WS_S2\App_Code\ZaloMoProcess.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "F4F394CB603F76088CB0956E2A2ADC65A38BE702"

#line 1 "D:\VU_NGUYEN\ViSport\VISPORT_TO_MrVU\ViSport_4.0\WS_S2\App_Code\ZaloMoProcess.cs"
using System;
using System.Data;
...
public class ZaloMoProcess : System.Web.Services.WebService {
        ...
        try
        {
            ...
            if (dtService != null && dtService.Rows.Count > 0)
            {
                ...
                if (Command_Code == "ZALO")
                {
                    ...
                    if (Service_ID == "8279")
                    {
                        ...
                        if (nowTime.Hour < 12) //TRA LUON KQ NGAY HOM TRUOC
                        {
                            ...
                            if (dtCon != null && dtCon.Rows.Count > 0)
                            {
                                ...
                                reMessage = "Cam on ban da su dung dich vu KQXS cua Zalo. Ket qua xo so " + companyName + " moi nhat se duoc gui den ban tren tin nhan cua Zalo. DTHT - HOTLINE: 19001255";
                        ...
                        if (nowTime.Hour > 12)
                        {
                            ...
                            else
                            {
                                ...
                                reMessage = "Ket qua xo so " + companyName + " ngay " + ngay + " se duoc he thong gui den ban ngay khi co ket qua tren tin nhan ZALO. DTHT - HOTLINE: 19001255";
                    ...
                    else if(Service_ID == "8179")
                    {
                        ...
                        else
                        {
                            ...
                            reMessage = "Ket qua xo so " + companyName + " moi nhat se duoc he thong gui den ban ngay khi co ket qua tren tin nhan ZALO. DTHT - HOTLINE: 19001255";
                            //GUI MT THONGBAO He Thong Da ghi Nhan SMS
                            SendMt(User_ID, Service_ID, Command_Code, reMessage, Request_ID);
                    ...
                    else if (Service_ID == "8379")
                    {
                        #region 2. Nhận kết quả xổ số mới nhất theo miền
                            ...
                            reMessage = "Cam on ban da su dung dich vu KQXS cua Zalo. Ket qua xo so ban yeu cau se duoc gui den ban tren tin nhan cua Zalo. DTHT - HOTLINE: 19001255";
                            SendMt(User_ID, Service_ID, Command_Code, reMessage, Request_ID);
                    ...
                    else if (Service_ID == "8779")
                    {
                        ...
                        reMessage = "Ban da dang ky su dung dich vu Xo so " + companyName + " trong 30 ngay lien tiep cua ZALO. Chuc ban may man! DTHT - HOTLINE: 19001255";
                        SendMt(User_ID, Service_ID, Command_Code, reMessage, Request_ID);
                ...
                else if (Command_Code == "CAUZALO")
                {
                    ...
                    reMessage = "Cam on ban da su dung dich vu Cap so may man cua Zalo. Cap so may man " + companyName + " ky toi se duoc gui den ban tren tin nhan cua Zalo. DTHT - HOTLINE: 19001255";
    ...
    private static void SendMt(string userId,string serviceId,string commandCode,string message,string requestId)
    {
        ...
        //message = message.Replace("DTHT - HOTLINE: 19001255", "DTHT-HOTLINE: 19001255");
