...
namespace VNM_VClip_SpamSms.Library
{
    public class SMS_MTDB_SQL
    {
        ...
        public static DataTable GetMTByStatus(bool isLock)
        {
            ...
            SqlCommand dbCmd = new SqlCommand("VClip_GetAllUserByType_SpamSms", dbConn);
        ...
        {
            SqlConnection dbConn = new SqlConnection(SMS.Default.cnn);
            SqlCommand dbCmd = new SqlCommand("VClip_UpdateByList_SpamSms", dbConn);
            dbCmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlConnection dbConn = new SqlConnection(SMS.Default.cnn);
            SqlCommand dbCmd = new SqlCommand("VClip_S2_Registered_Users_Update_Fail_SpamSms", dbConn);
            dbCmd.CommandType = CommandType.StoredProcedure;
