#pragma checksum "D:\VU_NGUYEN\ViSport\VISPORT_TO_MrVU\ViSport_4.0\WS_S2\App_Code\ViSport_S2_Registered\ViSport_S2_Registered_UsersController.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9E720170B91C0AB195134BC777AC715DE37882BA"

#line 1 "D:\VU_NGUYEN\ViSport\VISPORT_TO_MrVU\ViSport_4.0\WS_S2\App_Code\ViSport_S2_Registered\ViSport_S2_Registered_UsersController.cs"
using System;
...
public class ViSport_S2_Registered_UsersController
{
    ...
    public static DataTable GetSportGameHeroUserInfoActive(string userId)
    {
        DataSet ds = SqlHelper.ExecuteDataset(AppEnv.ConnectionString, "Sport_Game_Hero_GetUserInfo_Active", userId);
        if (ds != null && ds.Tables.Count > 0)
        {
            return ds.Tables[0];
        }
