#pragma checksum "D:\VU_NGUYEN\ViSport\VISPORT_TO_MrVU\ViSport_4.0\WS_S2\App_Code\WebService.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8EAEE6B8F30964B32247041E4BD7065734E5E2D1"

#line 1 "D:\VU_NGUYEN\ViSport\VISPORT_TO_MrVU\ViSport_4.0\WS_S2\App_Code\WebService.cs"
using System;
        ...
        try
        {
            ...
            else if( (Command_Code == "TP" || Command_Code == "TP1" ) && subcode == "") //DK DICH VU TRIEU_PHU_BONG_DA
            {
                ...
                if (value.Rows[0]["RETURN_ID"].ToString() == "0")//DK DICH VU LAN DAU
                {
                    ...
                    if (Command_Code == "TP")
                    {
                        messageReturn = "Chuc mung ban da tham gia CTKM Trieu phu bong da cua Vietnamobile. " +
                                        "Ban co 5.000 diem voi co hoi trung thuong 1 dien thoai Samsung Galaxy A5. " +
                                        "Moi ngay ban se nhan duoc nhung tin tuc the thao nong hoi (5000d/ngay). " +
                ...
                else if (value.Rows[0]["RETURN_ID"].ToString() == "2")
                {
                    ...
                    if (Command_Code == "TP")
                    {
                        messageReturn = "Chuc mung ban da tham gia  CTKM Trieu phu bong da cua Vietnamobile.  Ban co 5.000 diem voi co hoi trung thuong 1 dien thoai Samsung Galaxy A5. Moi ngay ban se nhan duoc nhung tin tuc the thao nong hoi. Truy cap: http://visport.vn de su dung dvu. De huy dvu soan: HUY TP gui 979. HT: 19001255";
                    }
                    else
                    {
                ...
                else if (value.Rows[0]["RETURN_ID"].ToString() == "1")//DA DK DICH VU
                {
                    ...
                    messageReturn = "Ban da tham gia  CTKM Trieu phu bong da cua Vietnamobile.  Ban co 5.000 diem voi co hoi trung thuong 1 dien thoai Samsung Galaxy A5. Moi ngay ban se nhan duoc nhung tin tuc the thao nong hoi. Truy cap: http://visport.vn de su dung dvu. De huy dvu soan: HUY TP gui 979. HT: 19001255";
                    //SendMtSportGameHero(User_ID, messageReturn, Service_ID, Command_Code, Request_ID, 0);
            ...
            else if (Command_Code.ToUpper() == "DIEM" && subcode == "") //TRA DIEM TRIEU PHU BONG DA
            {
                ...
                mtx = "Ban dang co <DIEM> diem trong cuoc dua den giai thuong Samsung Galaxy A5. Soan TOP gui 979 de biet vi tri cua minh tren bang xep hang";
            ...
            {               
                #region TRA CUU TOP
                if (DateTime.Now > new DateTime(2015, 10, 16) && DateTime.Now < new DateTime(2015, 11, 17))
                {
                    string mtx = "";
                    string sodiem = "0";
                    int thutu = 0;
                    ...
                    if (returnchargValue == "1")
                    {
                        ...
                        if (thutu > 0)
                        {
                            if (thutu <= 5)
                            {
                                mtx = "Ban dang co <DIEM> diem va nam trong top 5 diem cao nhat. Giai thuong Samsung Galaxy A5 dang nam trong tam tay ban. Co gang len.";
                            }
                            else if (thutu > 5 && thutu <= 10)
                            {
                                mtx = "Ban dang co <DIEM> diem va nam trong top 10 diem cao nhat. Giai thuong Samsung Galaxy A5 dang nam trong tam tay ban. Co gang len.";
                            }
                            else if (thutu > 10 && thutu < 100)
                            {
                                mtx = "Ban dang co <DIEM> diem va nam trong top 100 diem cao nhat. Giai thuong Samsung Galaxy A5 dang nam trong tam tay ban. Co gang len.";
                            }
                            else if (thutu >= 100)
                            {
                                mtx = "Ban dang co <DIEM> diem. Co gang len de lot vao top 5 voi co hoi trung thuong Samsung Galaxy A5danh cho KH co diem so cao nhat.";
                            }
                            //SendMtSportGameHero(User_ID, mtx.Replace("<DIEM>", sodiem), Service_ID, Command_Code, Request_ID, 0);
            ...
            else if(Command_Code.ToUpper() == "HD" && subcode == "") //HUONG DAN CHUONG TRINH
            {
                ...
                messageReturn =
                    "De dang ky CTKM Chuyen gia bong da cua Vietnamobile soan: TP gui 979, " +
                    "huy dich vu soan: HUY TP gui 979, " +
                    "xem ma du thuong truy cap http://visport.vn";
            ...
            else if (Command_Code.ToUpper() == "HUY" && (subcode.ToUpper() == "TP" || subcode.ToUpper() == "TP1" )) //HUY DV TRIEU_PHU_BONG_DA
            {
                ...
                //{
                    if (dtUpdate.Rows[0]["RETURN_ID"].ToString() == "1")
                    {
                        messageReturn = "Quy khach da huy thanh cong dich vu Visport cua Vietnamobile. Quy khach da bo lo co hoi so huu dien thoai Samsung Galaxy A5. De dang ky su dung lai dich vu, soan TP gui 979. Chi tiet truy cap http://visport.vn. HT: 19001255";
                        SendMtSportGameHero(User_ID, messageReturn, Service_ID, Command_Code, Request_ID, 0);
                    }
                    else
                    {
            ...
            else if ((Command_Code.ToUpper() == "1" || Command_Code.ToUpper() == "2") && subcode == "")
            {
                ...
                //{
                    ...
                    DataTable dtCount = ViSport_S2_Registered_UsersController.GetSportGameHeroUserInfoActive(User_ID);
                    if(dtCount == null || dtCount.Rows.Count == 0)
                    {
                        messageReturn = "Quy khach chua su dung dich vu Visport cua Vietnamobile. De dang ky su dung dich vu, soan TP gui 979. Chi tiet truy cap http://visport.vn. HT:19001255";
            ...
            else
            {
                ...
                messageReturn = "Tin nhan sai cu phap. " +
                                "De nhan 2 MDT va co co hoi trung Samsung Galaxy S4 soan TP gui 979 (mien phi dang ky), " +
                                "de biet them thong tin soan: HD gui 979. HT: 19001255";
                SendMtSportGameHero(User_ID,messageReturn,Service_ID,Command_Code,Request_ID,0);
            }
        }
        catch (Exception ex)
