#pragma checksum "D:\VU_NGUYEN\ViSport\VISPORT_TO_MrVU\ViSport_4.0\WS_S2\App_Code\VclipGetUsers.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "910825EE0423FD6F1B2EB1DD2E665CE7DFFA4F14"

#line 1 "D:\VU_NGUYEN\ViSport\VISPORT_TO_MrVU\ViSport_4.0\WS_S2\App_Code\VclipGetUsers.cs"
using System;
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ViSport_S2_Registered_UsersController.WorldCupUserInsertToAndy(
                        ...
                        userName,
                        userPass,
                        "http://123.29.67.167:8000/JobSubs/VClip/VclipNotification.asmx"
                        );
                }
            }
        }
