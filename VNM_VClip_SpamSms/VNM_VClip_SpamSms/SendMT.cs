...
namespace VNM_VClip_SpamSms
{
    public partial class SendMT : ServiceBase
    {
        ...
        protected override void OnStart(string[] args)
        {
            ...
            {
                _logger.Error(string.Concat("Error - VNM_VClip_SpamSms.SendMT.Onstart: ", ex.Message));
                _logger.Error(string.Concat("Error - VNM_VClip_SpamSms.SendMT.Onstart: ", ex.StackTrace));
            }            
        }        
