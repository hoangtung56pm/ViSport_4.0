...
namespace VNM_ViSport_SpamSms
{
    public partial class SendMT : ServiceBase
    {
        ...
        protected override void OnStart(string[] args)
        {
            ...
            {
                _logger.Error(string.Concat("Error - VNM_ViSport_Charging.SendMT.Onstart: ", ex.Message));
                _logger.Error(string.Concat("Error - VNM_ViSport_Charging.SendMT.Onstart: ", ex.StackTrace));
            }            
        }        
        ...
        private object DoSomeWork1(object obj)
        {
            try
            {
                MSMProccess.SentMtInfo((ViSport_S2_Registered_UsersInfo)obj);               
            }
            catch (Exception ex)
            {
