...
namespace SentMT {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="sendMTSoapBinding", Namespace="http://123.29.69.168/api/services/sendMT")]
    public partial class ServiceProviderService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public ServiceProviderService() {
            string urlSetting = System.Configuration.ConfigurationManager.AppSettings["SentMT.sendMT"];
            if ((urlSetting != null)) {
                this.Url = urlSetting;
            }
            else {
                this.Url = "http://123.29.69.168/api/services/sendMT";
            }
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace="http://mt.webservice.ems.vmg.com", ResponseNamespace="http://123.29.69.168/api/services/sendMT")]
        ...
        /// <remarks/>
        public System.IAsyncResult BeginsendMT(string userID, string message, string serviceID, string commandCode, string messageType, string requestID, string totalMessage, string messageIndex, string isMore, string contentType, System.AsyncCallback callback, object asyncState) {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginsendMTEx(string userID, string message, string serviceID, string commandCode, string messageType, string requestID, string totalMessage, string messageIndex, string isMore, string contentType, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("sendMTEx", new object[] {
                        userID,
                        message,
                        serviceID,
                        commandCode,
        ...
        /// <remarks/>
        public int EndsendMTEx(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((int)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginsendMTEx2(string userID, string message, string serviceID, string commandCode, string messageType, string requestID, string totalMessage, string messageIndex, string isMore, string contentType, int messageClass, int mwi, int dataCoding, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("sendMTEx2", new object[] {
                        userID,
                        message,
                        serviceID,
                        commandCode,
                        ...
                        messageClass,
                        mwi,
                        dataCoding}, callback, asyncState);
        }
        
        /// <remarks/>
        public int EndsendMTEx2(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((int)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginsendMTPush(string userID, string message, string serviceID, string commandCode, string messageType, string requestID, string totalMessage, string messageIndex, string isMore, string contentType, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("sendMTPush", new object[] {
                        userID,
                        message,
                        serviceID,
                        commandCode,
        ...
        /// <remarks/>
        public int EndsendMTPush(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((int)(results[0]));
        }
