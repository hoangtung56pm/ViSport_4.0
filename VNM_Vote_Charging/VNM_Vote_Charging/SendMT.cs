...
namespace VNM_ViSport_Charging
{
    public partial class SendMT : ServiceBase
    {
        ...
        protected override void OnStart(string[] args)
        {
            ...
            {
                _logger.Error(string.Concat("Error - VNM_Vote_Charging.SendMT.Onstart: ", ex.Message));
                _logger.Error(string.Concat("Error - VNM_Vote_Charging.SendMT.Onstart: ", ex.StackTrace));
            }            
        }        
