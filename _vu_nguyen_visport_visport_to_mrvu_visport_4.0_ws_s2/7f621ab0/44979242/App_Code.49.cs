#pragma checksum "D:\VU_NGUYEN\ViSport\VISPORT_TO_MrVU\ViSport_4.0\WS_S2\App_Code\JobsSubS294XBonus.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "A71960EC8774A6BB722FB5573F0F4070E0DC8B34"

#line 1 "D:\VU_NGUYEN\ViSport\VISPORT_TO_MrVU\ViSport_4.0\WS_S2\App_Code\JobsSubS294XBonus.cs"
using System;
...
/// <summary>
/// Summary description for JobsSubS294XBonus
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
// [System.Web.Script.Services.ScriptService]
public class JobsSubS294XBonus : System.Web.Services.WebService, IJobExecutorSoap
{

    public JobsSubS294XBonus()
    {
    ...
    readonly log4net.ILog _log = log4net.LogManager.GetLogger(typeof(JobsSubS294XBonus));
    ...
    public int Execute(int jobID)
    {
        try
        {
            ...
            DataTable dtUser = ViSport_S2_Registered_UsersController.S294XGetUserRegistered();
                ...
                foreach(DataRow dr in dtUser.Rows)
                {
                    ...
                    if (returnValue == "1")//CHARGED THANH CONG
                    {
                        ...
                        ViSport_S2_Registered_UsersController.S294XChargedUserLog3G(
                                                        ...
                                                        dr["Command_Code"].ToString(), "1000", "Charged Shit", "1", userName);
