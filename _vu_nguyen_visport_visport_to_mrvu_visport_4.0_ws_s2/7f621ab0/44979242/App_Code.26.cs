#pragma checksum "D:\VU_NGUYEN\ViSport\VISPORT_TO_MrVU\ViSport_4.0\WS_S2\App_Code\Xosocactinh.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3BA8C657F63D747DEF1DF391B72291E18E12DCA8"

#line 1 "D:\VU_NGUYEN\ViSport\VISPORT_TO_MrVU\ViSport_4.0\WS_S2\App_Code\Xosocactinh.cs"
using System;
...
/// <summary>
/// Summary description for Xosocactinh
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
// [System.Web.Script.Services.ScriptService]
public class Xosocactinh : System.Web.Services.WebService, IJobExecutorSoap
{
    ...
    readonly log4net.ILog _log = log4net.LogManager.GetLogger(typeof(Xosocactinh));
    ...
    public int Execute(int jobID)
    {
        ...
        try
        {
            ...
            DataTable dtUser = ViSport_S2_Registered_UsersController.S294XGetUserRegisteredByServiceId(3);
                ...
                foreach (DataRow dr in dtUser.Rows)
                {
                    ...
                    if (returnValue == "1")//CHARGED THANH CONG
                    {
                        ...
                        ViSport_S2_Registered_UsersController.S294XChargedUserLog3G(
                                                        ...
                                                        dr["Command_Code"].ToString(), "1000", "Charged 3 Shit", "1", userName);
