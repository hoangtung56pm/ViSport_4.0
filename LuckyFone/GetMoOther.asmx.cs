...
{
    /// <summary>
    /// Summary description for GetMoOther
    /// </summary>
    [WebService(Namespace = "http://tempuri.org/")]
    [WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
    [System.ComponentModel.ToolboxItem(false)]

    public class GetMoOther : WebService, IJobExecutorSoap
    {
        ...
        readonly log4net.ILog Log = log4net.LogManager.GetLogger(typeof(GetMoOther));
